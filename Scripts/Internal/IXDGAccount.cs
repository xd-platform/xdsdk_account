...
namespace XD.SDK.Account.Internal{
    ...
    {
        void Login(List<LoginType> loginTypes, Action<IXDGUser> callback,
            Action<IXDGError> errorCallback);

        void LoginByType(LoginType loginType, Action<IXDGUser> callback,
            Action<IXDGError> errorCallback);
        ...
        void LoginByConsole(Action<IXDGUser> successCallback, Action failCallback,
            Action<IXDGError> errorCallback);
        ...
        void GetUser(Action<IXDGUser> callback, Action<IXDGError> errorCallback);
        ...
        //除了 Default 和 Guest
        void BindByType(LoginType loginType, Action<bool, IXDGError> callback);
